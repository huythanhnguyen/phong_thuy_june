// Ý nghĩa từng số - dựa từ chatbotsdtapi backend
export const DIGIT_MEANINGS = {
...
// Hàm helper để lấy ý nghĩa số theo vị trí
export function getDigitMeaning(digit, position) {
    switch(position) {
        case 'single':
            return DIGIT_MEANINGS.SINGLE_DIGIT_MEANINGS[digit] || 'Không có thông tin';
        case 'third_from_end':
            return DIGIT_MEANINGS.THIRD_FROM_END_MEANINGS[digit] || 'Không có thông tin';
        case 'fifth_from_end':
            return DIGIT_MEANINGS.FIFTH_FROM_END_MEANINGS[digit] || 'Không có thông tin';
        default:
            return DIGIT_MEANINGS.SINGLE_DIGIT_MEANINGS[digit] || 'Không có thông tin';
    }
} 